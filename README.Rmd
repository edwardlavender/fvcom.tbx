...
* `define.new2dfield()` - define new 2 dimensional hydrodynamic fields from WeStCOMS outputs (namely, thermocline strength, wind speed, wind direction, current speed, current direction and sun angle);
...
* Validation of WeStCOMS predictions using (benthic) animal movement (passive acoustic telemetry and depth timeseries) data;

...
#' @param define A character that specifies whether 'x' is to be converted from a date to a date_name (\code{define = "date_name"}) or from a date_name to a date (\code{define = "date"}).
#'

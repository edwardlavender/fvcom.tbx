...
#' @param xysp A \code{\link[sp]{SpatialPoints-class}} object which defines the positions at which to identify mesh IDs. Alternatively, \code{lat} and \code{long} or \code{dat} can be provided (see above).
#' @param mesh A mesh, created by \code{\link[fvcom.tbx]{build_mesh}}, that surrounds nodes or elements.
#' @param proj A projection string of class code{\link[sp]{CRS-class}}. The default is World Geodetic System 84 (WGS84). This should be the same as for \code{mesh} and inputted coordinates.

...
#' @param warning_threshold A number which defines the number of metres beyond the depth of the seabed (i.e., the calculated depth for layer 10) after which the function will warn the user if there are depth observations substantially deeper than the depth of the seabed. This may be due to inaccuracies in recorded depths and these can lead to interpolation errors for fractional layer IDs, if these are assigned to observed depths.

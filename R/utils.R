...
#' @param method A character that defines the matching method. The options currently implemented are \code{"match_ts_nearest"}, which implements \code{match_ts_nearest} and \code{"match_ts_nearest_by_key"} which implements \code{match_ts_nearest_by_key}.
